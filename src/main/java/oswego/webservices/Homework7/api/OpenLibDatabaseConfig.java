...
import static oswego.webservices.Homework7.api.TomcatDatabaseConfig.getLocalContainerEntityManagerFactoryBean;

@Configuration
@PropertySource({"classpath:application.properties"})
@EnableJpaRepositories(
        basePackages = "oswego.webservices.Homework7.model.openlib",
...
public class OpenLibDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean bookEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "oswego.webservices.Homework7.api.openlib" });
